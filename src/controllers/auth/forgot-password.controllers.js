...
async function forgotPasswordControllers(req, res) {
    ...
    .then((user) => {
        ...
        const data = {
            ...
            to: email,
            subject: `MyFreelance - Mot de passe oublié ?`,
            html: `
                ...
                <br/> Pas de soucis, cliquez sur le lien ci-dessous afin de le réinitialiser.
                                    ...
                                    <tr>
                                        <td style="text-align:center;">
                                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>www.myfreelance.com</strong></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height:80px;">&nbsp;</td>
        ...
        .then((success) => {
            if(success) {
                sending.messages().send(data, function (err) {
